  ...
  _renderButtons(links) {
    return (
      <td className="noegletal-vaerdi" key={links.xbrl}>
        {links.xbrl && <a href={links.xbrl} title="Hent regnskab i XBRL format" target="_blank" className="btn btn-primary btn-sm"><span className="fa fa-file-code-o" download={true} /></a>}
        &nbsp;
