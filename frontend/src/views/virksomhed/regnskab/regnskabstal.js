...
export default class Regnskabstal extends Component {
  ...
  render() {
    const brutto = this.props.regnskab.aktueltAarsregnskab.resultatopgoerelse.bruttoresultatTal
    const aaretsresultat = this.props.regnskab.aktueltAarsregnskab.resultatopgoerelse.aaretsresultatTal
    const passiver = this.props.regnskab.aktueltAarsregnskab.balance.passiver
